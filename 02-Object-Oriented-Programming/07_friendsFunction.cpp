...
public:
    ...
    friend Complex sumComplex(Complex obj1, Complex obj2); // this means sumcomplex function have acces to class but can't acces variables and fucntion directly 
